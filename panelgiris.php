...
<form action="panelgiris.php" method="post" style="max-width:500px;margin:auto ">
  <h2 style="color: white; ; text-align: center">Giriş</h2>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="text" placeholder="Sicil Numarası" name="usrnm">
  </div>
...
if(isset($_POST["usrnm"], $_POST["psw"] )) {
    ...
    if($_POST["usrnm"]=="4586" && $_POST["psw"]=="190999") {
     ...
     echo "<script>alert('Sicil no veya Şifre Yanlış')</script>";   
